...
<head>
	...
	<link rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/osticket.css?b42ddc7" media="screen"/>
    <link rel="stylesheet" href="<?php echo ASSETS_PATH; ?>css/theme.css?b42ddc7" media="screen"/>
    <link rel="stylesheet" href="<?php echo ASSETS_PATH; ?>css/print.css?b42ddc7" media="print"/>
    <link rel="stylesheet" href="<?php echo ROOT_PATH; ?>scp/css/typeahead.css?b42ddc7"
         media="screen" />
    ...
    <link rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/thread.css?b42ddc7" media="screen"/>
    ...
    <script src="<?php echo ROOT_PATH; ?>js/osticket.js?b42ddc7"></script>
    <script type="text/javascript" src="<?php echo ROOT_PATH; ?>js/filedrop.field.js?b42ddc7"></script>
    <script src="<?php echo ROOT_PATH; ?>scp/js/bootstrap-typeahead.js?b42ddc7"></script>
